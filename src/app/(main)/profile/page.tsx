...
import { Camera, User, Mail, Home, MapPin, Loader2, LogOut, Save, Phone, Lock, Eye, EyeOff, X, Check } from "lucide-react";
        ...
        try {
            ...
            if (newPassword) {
                try {
                    ...
                    toast({ title: "Password Updated", description: "Your login credentials have been secured." });
                } catch (authError: any) {
            ...
            toast({ 
                ...
                description: "Your official member profile has been synchronized." 
            });
        ...
        <div className="flex flex-col min-h-screen bg-gray-50/50">
            ...
            <div className="p-4 md:p-8 max-w-5xl mx-auto w-full">
                <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-24">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <Card className="shadow-lg border-primary/10 overflow-hidden">
                            ...
                            <CardContent className="pt-6 space-y-4">
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-primary text-center block">Update Profile Photo</Label>
                                    ...
                                    {isCameraOpen ? (
                                                ...
                                                {hasCameraPermission === false && (
                                                    <div className="absolute inset-0 flex items-center justify-center p-4 text-center">
                                                        <Alert variant="destructive">
                                                            ...
                                                            <AlertDescription className="text-xs">Please enable camera or upload a file.</AlertDescription>
                                                        </Alert>
                                                    </div>
                                                )}
                                            </div>
                                            <div className="flex gap-2">
                                                <Button type="button" onClick={capturePhoto} className="flex-1 text-xs font-bold">
                                                    <Check className="mr-2 h-3 w-3" /> Capture
                                                </Button>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <Button type="button" variant="outline" className="w-full text-xs font-bold" onClick={startCamera}>
                                                <Camera className="mr-2 h-4 w-4 text-primary" /> Take Selfie
                                            </Button>
                                            <Button type="button" variant="ghost" className="w-full text-[10px] font-bold uppercase tracking-widest" onClick={() => fileInputRef.current?.click()}>
                                                Upload Image File
                                            </Button>
                        ...
                        <Card className="shadow-lg border-t-4 border-destructive/20">
                            <CardHeader className="pb-2">
                                ...
                                <CardDescription className="text-[10px]">Change your portal access password.</CardDescription>
                            </CardHeader>
                    ...
                    {/* Right Column: Registry Details Form */}
                    <div className="lg:col-span-2 space-y-6">
                        <Card className="shadow-xl border-t-4 border-primary">
                            <CardHeader>
                                ...
                                <CardDescription>Update your official residential and contact data in the National Registry.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="grid gap-2">
                                        <Label htmlFor="phoneNumber" className="text-[10px] font-black uppercase tracking-widest text-primary">Official Contact Number</Label>
                                        <div className="relative">
                            ...
                            <CardFooter className="bg-muted/30 border-t pt-6">
                                <Button type="submit" className="w-full md:w-auto h-12 px-10 text-lg font-black uppercase tracking-widest shadow-lg" disabled={saving}>
                                    {saving ? (
                                        <><Loader2 className="mr-2 h-5 w-5 animate-spin" /> Syncing Registry...</>
                                    ) : (
                        ...
                        <div className="bg-amber-50 p-6 rounded-xl border border-dashed border-amber-200">
                            <h3 className="text-xs font-black uppercase text-amber-800 tracking-widest mb-2 flex items-center gap-2">
                                <MapPin className="h-3 w-3" />
                                Regional Mobilization Note
                            </h3>
                            <p className="text-[11px] text-amber-900/70 leading-relaxed font-medium">
                                Your jurisdictional data determines your eligibility for local leadership positions and regional party alerts. Please ensure your Barangay and City information matches your current residence for accurate mobilization during election periods.
                            </p>
                        </div>
                    </div>
                </form>
